...
#define S3C_CIIMGEFF_PAT_CB(x)			((x&0xff) << 13)
#define S3C_CIIMGEFF_PAT_CR(x)			((x&0xff) << 0)
...
#if 0
// changed by jamie for consistency with CIOCTRL (2009.09.15)
#define S3C_MSCTRL_2PLANE_MSB_CRCB		(0 << 16)
#define S3C_MSCTRL_2PLANE_MSB_CBCR		(1 << 16)
#define S3C_MSCTRL_2PLANE_LSB_CRCB		(2 << 16)
#define S3C_MSCTRL_2PLANE_LSB_CBCR		(3 << 16)
#else
#define S3C_MSCTRL_2PLANE_LSB_CBCR		(0 << 16)
#define S3C_MSCTRL_2PLANE_LSB_CRCB		(1 << 16)
#define S3C_MSCTRL_2PLANE_MSB_CRCB		(2 << 16)
#define S3C_MSCTRL_2PLANE_MSB_CBCR		(3 << 16)
#endif
...
#define S3C_CIEXTEN_MAINHRATIO_EXT_MASK		(0x3f << 10)
#define S3C_CIEXTEN_MAINVRATIO_EXT_MASK		(0x3f << 0)
