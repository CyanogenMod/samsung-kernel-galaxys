...
static struct s3c_gpio_chip gpio_chips[] = {
	...
	}, 
	{
		...
		.base	= S5PC1XX_GPL0_BASE,
		.config	= &gpio_cfg_noint,
		.chip	= {
			.base	= S5PC1XX_GPL0(0),
			.ngpio	= S5PC1XX_GPIO_L0_NR,
			.label	= "GPL0",
		},
	}, {
		.base	= S5PC1XX_GPL1_BASE,
		.config	= &gpio_cfg_noint,
		.chip	= {
			.base	= S5PC1XX_GPL1(0),
			.ngpio	= S5PC1XX_GPIO_L1_NR,
			.label	= "GPL1",
		},
	}, {
		.base	= S5PC1XX_GPL2_BASE,
		.config	= &gpio_cfg_noint,
		.chip	= {
			.base	= S5PC1XX_GPL2(0),
			.ngpio	= S5PC1XX_GPIO_L2_NR,
			.label	= "GPL2",
		},
	}, {
		.base	= S5PC1XX_GPL3_BASE,
		.config	= &gpio_cfg_noint,
		.chip	= {
			.base	= S5PC1XX_GPL3(0),
			.ngpio	= S5PC1XX_GPIO_L3_NR,
			.label	= "GPL3",
		},
	}, {
		.base	= S5PC1XX_GPL4_BASE,
		.config	= &gpio_cfg_noint,
		.chip	= {
			.base	= S5PC1XX_GPL4(0),
			.ngpio	= S5PC1XX_GPIO_L4_NR,
			.label	= "GPL4",
		},
	}, 
};
