...
#define S5PC1XX_GPB0_SPI_MISO0		(0x2 << 0)
#define S5PC1XX_GPB0_GPIO_INT2_0	(0xf << 0)

#define S5PC1XX_GPB1_SPI_CLK0		(0x2 << 4)
#define S5PC1XX_GPB1_GPIO_INT2_1	(0xf << 4)

#define S5PC1XX_GPB2_SPI_MOSI0		(0x2 << 8)
#define S5PC1XX_GPB2_GPIO_INT2_2	(0xf << 8)

#define S5PC1XX_GPB3_SPI_CS0		(0x2 << 12)
#define S5PC1XX_GPB3_GPIO_INT2_3	(0xf << 12)

#define S5PC1XX_GPB4_SPI_MISO1		(0x2 << 16)
#define S5PC1XX_GPB4_GPIO_INT2_4	(0xf << 16)

#define S5PC1XX_GPB5_SPI_CLK1		(0x2 << 20)
#define S5PC1XX_GPB5_GPIO_INT2_5	(0xf << 20)

#define S5PC1XX_GPB6_SPI_MOSI1		(0x2 << 24)
#define S5PC1XX_GPB6_GPIO_INT2_6	(0xf << 24)

#define S5PC1XX_GPB7_SPI_CS1		(0x2 << 28)
